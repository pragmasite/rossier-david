    ...
    <section className="relative min-h-screen overflow-hidden pt-20">
      ...
      <div className="pointer-events-none absolute inset-0">
        <motion.div
          ...
          className="absolute -right-20 top-1/4 h-64 w-64 rounded-full bg-accent/20 blur-3xl"
        />
        <motion.div
          animate={{ y: [0, 20, 0] }}
          transition={{ duration: 10, repeat: Infinity }}
          className="absolute -left-20 bottom-1/4 h-48 w-48 rounded-full bg-primary/20 blur-3xl"
        />
      </div>
      ...
      <div className="container relative mx-auto flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        >
          ...
          >
            <a href="mailto:contact@davidrossier.ch" className="flex items-center gap-2">
